...
* @author GRIP
*/
public class GripPipelineBlue implements VisionPipeline {
	...
	public static final int PIPELINE_WIDTH = 480;
	public static final int PIPELINE_HEIGHT = 360;
	...
	public void process(Mat source0) {
		...
		Size cvResizeDsize = new Size(PIPELINE_WIDTH, PIPELINE_HEIGHT);
		double cvResizeFx = 1;
		double cvResizeFy = 1;
		...
		double[] hsvThresholdSaturation = {99, 255.0};
