...
* @author GRIP
*/
public class GripPipelineThree implements VisionPipeline {
	...
	public static final int PIPELINE_WIDTH = 120;
	public static final int PIPELINE_HEIGHT = 90;
